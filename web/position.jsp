...
<html lang="en">
    <head>
        ...
        <title>Posiciones - CONSTRU SV</title>
        <!-- Icon -->
...
%>
    <body class="bg-black">
        ...
        <div class="text-white flex justify-center mt-4">
            <h1 class="text-white text-4xl font-bold text-center">Gestión Posiciones</h1>
        </div>
        ...
        <div class="text-white flex justify-center w-full md:w-auto mt-4">
            <form id="frmMain" action="positionController" method="POST">
                    ...
                    <label>Nombre de Posición: </label><br>
                    <input type="text" name="txtPosName" id="txtPosName" class="text-black font-bold text-lg p-2 rounded" required/><br>
                    <label>Departamento: </label><br>
                    <select name="slctDept" id="slctDept" class="text-black font-bold text-lg p-2 rounded">
                        <%
        ...
        <div class="text-white flex justify-center w-full md:w-auto mt-4">
            <table>
                <thead>
                    ...
                    <th class="border-2 border-white border-dashed p-4 text-lg">Departamento</th>
                ...
                %>
                <tr>
                    <td class="border-2 border-white border-dashed p-4"><%= p.getId()%></td>
                    <td class="border-2 border-white border-dashed p-4"><%= p.getName()%></td>
                    <td class="border-2 border-white border-dashed p-4"><%= dpt.getDept(p.getDepartment_id()).getName()%></td>
                    <td class="border-2 border-white border-dashed p-4">
                        <a href="javascript:myLoad('<%= p.getId()%>','<%= p.getName()%>','<%= p.getDepartment_id()%>')"
