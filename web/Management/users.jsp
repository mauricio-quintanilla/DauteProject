...
<head>
    ...
    <title>Usuarios Clientes - CONSTRU SV</title>
    <!-- Icon -->
...
<body class="bg-black">
    ...
    <div class="text-white flex justify-center mt-4">
        <h1 class="text-white text-4xl font-bold text-center">Gestión Usuarios Clientes</h1>
    </div>
    ...
    <div class="text-white flex justify-center w-full md:w-auto mt-4">
        <form id="frmMain" action="../userControllerE" method="POST">
            <div id="question"></div>
    ...
    <div class="text-white flex justify-center w-full md:w-auto mt-4 px-4 overflow-x-auto">
        ...
        <table>
            ...
            <tbody>
            <%
                List<Users> lst2 = usr.showClientUsersTable();
                for (Users u : lst2) {
            %>
            <tr>
