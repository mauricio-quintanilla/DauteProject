...
<div class="text-white flex justify-center w-full md:w-auto mt-4">
    <form id="frmMain" action="workingDetalleController" method="POST">
        ...
        <input type="hidden" name="slctProId" id="slctProId" value="<%= (Integer) session.getAttribute("id_attr")%>">
            ...
            <div id="divUpdDel">
                ...
                <input type="date" name="datFrom" id="datFrom" class="text-black font-bold text-lg p-2 rounded" required/> <br>
    ...
    <table>
        <thead>
            <th class="border-2 border-white border-dashed p-2">Proyecto</th>
        ...
        <%
            List<Working> lst1 = wop.showWorking();
            double total = 0;
            double totalF = 0;
            for (Working w : lst1) {
        ...
        %>
        <tr>
            <td class="border-2 border-white border-dashed p-2"><%= prj.getProyect(w.getProject_id()).getName() %></td>
