...
<body class="">
    <div class="flex flex-col-reverse md:flex-row h-screen">
        ...
        <divB class="w-full md:w-3/5 h-3/4 flex-grow md:h-screen flex md:rounded-l-xl bg-black" >
                ...
                <div class="p-4">
                    ...
                    <form id="frmMain" action="loginController" method="POST">                        
                        ...
                        <div class="flex justify-center mt-4">
                            <input type="submit" name="btnLogIn" id="btnLogIn" value="Iniciar Sersión" class="px-8 py-4 rounded-full"/>
                        </div>
                    </form>
                </div>
            </div>
